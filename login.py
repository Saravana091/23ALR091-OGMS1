...
mycon = sql.connect(host="localhost", user="root", password="", database="grocery_store")
cur1 = mycon.cursor()
cur2 = mycon.cursor()
...
def submit2():
    ...
    myconnect = sql.connect(host="localhost", user="root", password="", database="grocery_store")
    ...
    def addbtn_func():
        try:
            if(addprodid_t1.get() == 0):
                ...
                if op > 0:
                    mycon1 = sql.connect(host="localhost", user="root", password="", database="grocery_store")
                    cur3 = mycon1.cursor()
